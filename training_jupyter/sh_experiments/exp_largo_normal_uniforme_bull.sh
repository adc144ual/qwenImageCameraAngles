...
OUTPUT_DIR="/home/antoniodetoro/nas_dataset/antonio/qwen/OUTPUTS_EXPERIMENTOS/exp_single_stage"
...
EXP_JSON="/home/antoniodetoro/nas_dataset/antonio/qwen/experimentos/exp_largo/dataset_splits_uniformes_rareza_ususarios.json"   # JSON original se llama dataset_splits_uniformes_rareza_ususarios.json
