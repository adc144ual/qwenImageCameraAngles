...
OUTPUT_DIR="/mnt/nas_dataset/antonio/qwen/OUTPUTS_EXPERIMENTOS/exp_single_stage_HRNet_98_02_12k"
...
EXP_JSON="/mnt/nas_dataset/antonio/qwen/experimentos/exp_largo/dataset_splits_synth_16_2.json"   # JSON original se llama dataset_splits_uniformes_rareza_ususarios.json
...
python ../finetune.py \
    ...
    --batch_size 1 \
    --learning_rate 1e-4 \
    --heatmap_loss_weight 0.02 \
    --velocity_loss_weight 0.98 \
